...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Fall back to DB lookup if email/name not passed directly
    ...
    const resultsUrl = `https://www.crarity.com/results?session=${session_id}`;
  ...
  <div style="max-width:520px;margin:40px auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
    ...
    <div style="padding:40px;">
      ...
      <p style="font-size:15px;color:#6b6b6b;margin:0 0 28px;line-height:1.6;">
        Hi ${candidateName}, your Crarity assessment has been reviewed and your results are ready to see.
      </p>
      ...
      <div style="background:#f7f6f3;border-radius:12px;padding:20px 24px;margin-bottom:28px;">
        ...
        <div style="display:flex;flex-direction:column;gap:10px;">
          <div style="display:flex;align-items:flex-start;gap:12px;">
            ...
            <div style="font-size:14px;color:#1a1a1a;line-height:1.5;">Click the button below to see your score - no login required.</div>
          </div>
          <div style="display:flex;align-items:flex-start;gap:12px;">
            ...
            <div style="font-size:14px;color:#1a1a1a;line-height:1.5;">If you passed, you'll be invited to complete your profile and get matched with employers.</div>
          </div>
          <div style="display:flex;align-items:flex-start;gap:12px;">
            ...
            <div style="font-size:14px;color:#1a1a1a;line-height:1.5;">Qualified candidates are visible to employers on Crarity who are actively hiring.</div>
          </div>
        </div>
      </div>
      ...
      <p style="font-size:13px;color:#6b6b6b;margin-top:20px;margin-bottom:0;line-height:1.6;">
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: [recipientEmail],
        subject: "Your Crarity assessment results are ready",
        html,
      }),
    });
    ...
    console.error("notify-scored error:", err);
